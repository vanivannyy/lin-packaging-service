...
import { drawCuttingLayout } from "@/lib/draw-cutting-layout";
import {
  hitungHppProduksi,
  ringkasKomposisi,
  type BiayaLainItem,
...
export function HppCalculatorForm({
  ...
  function applyReorder(q: QuotationOption) {
    ...
    setForm((prev) => ({
      ...
      marginKiri: typeof spec.marginKiri === "number" ? spec.marginKiri : prev.marginKiri,
      marginKanan: typeof spec.marginKanan === "number" ? spec.marginKanan : prev.marginKanan,
      marginAtas: typeof spec.marginAtas === "number" ? spec.marginAtas : prev.marginAtas,
      marginBawah: typeof spec.marginBawah === "number" ? spec.marginBawah : prev.marginBawah,
      gap: typeof spec.gap === "number" ? spec.gap : prev.gap,
      metodeHargaKertas:
            ...
            <form action={createQuotationFromHppAction} className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <input
                ...
                value={JSON.stringify({
                  ...
                  marginKiri: form.marginKiri,
                  marginKanan: form.marginKanan,
                  marginAtas: form.marginAtas,
                  marginBawah: form.marginBawah,
                  gap: form.gap,
